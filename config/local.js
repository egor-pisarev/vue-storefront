module.exports = {
    ...
    "entities": {
      ...
      "category": {
        ...
        "categoriesRootCategorylId": 1000000,
    ...
    "products": {
      ...
      "defaultFilters": require('../../vsf-moysklad-indexer/var/results/defaultFilters.json'),
      "systemFilterNames": [
        "sort"
      ],
      ...
      "filterAggregationSize": require('../../vsf-moysklad-indexer/var/results/filterAggregationSize.json'),
    ...
    "i18n": {
        ...
        "currencyCode": "RUB",
        "currencySign": "₽",
        "priceFormat": "{amount} {sign}",
        "dateFormat": "D.M.YYYY HH:mm",
        "fullCountryName": "Российская Федерация",
